...
import net.zorgblub.typhonkai.CustomOPDSSite;
...
public class CatalogActivity extends TyphonActivity implements CatalogParent {
    ...
    protected void onCreateTyphonActivity(Bundle savedInstanceState) {
        ...
        detailsFragment = (BookDetailsFragment) fragmentManager.findFragmentById(net.zorgblub.typhonkai.R.id.fragment_book_details);
        hideDetailsView();
    ...
    protected int getMainLayoutResource() {
        return net.zorgblub.typhonkai.R.layout.activity_catalog;
    }
    ...
    private void onBackStackChanged() {
        ...
        if ( fragmentManager.getBackStackEntryCount() > 0 ) {
            ...
            fragmentOption.forEach((Command<? super Fragment>) (fragment) -> {
    ...
    public void loadCustomSitesFeed() {
        ...
        if ( sites.isEmpty() ) {
            Toast.makeText(this, net.zorgblub.typhonkai.R.string.no_custom_sites, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        customSites.setTitle(getString(net.zorgblub.typhonkai.R.string.custom_site));
        ...
        fragmentTransaction.replace(net.zorgblub.typhonkai.R.id.fragment_catalog, newCatalogFragment, Catalog.CUSTOM_SITES_ID );
    ...
    public void loadFeed(Entry entry, String href, String baseURL, boolean asDetailsFeed) {
        ...
        fragmentTransaction.replace(net.zorgblub.typhonkai.R.id.fragment_catalog, newCatalogFragment, baseURL);
