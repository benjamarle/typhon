 ...
 *
 */
public class TyphonSpine implements Iterable<TyphonSpine.SpineEntry> {
	...
	public static final String COVER_HREF = "TyphonCover";
	...
	private Resource createCoverResource(Book book) {	
		...
		if ( book.getCoverPage() != null && book.getCoverPage().getSize() > 0
            ...
            Log.d("TyphonSpine", "Using cover resource " + book.getCoverPage().getHref() );

			return book.getCoverPage();
		}

        Log.d("TyphonSpine", "Constructing a cover page" );
