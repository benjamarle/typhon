...
public class SearchResultAdapter extends ArrayAdapter<SearchResult> implements
	...
	public SearchResultAdapter(Context context, BookView bookView, 
		...
		super(context, net.zorgblub.typhonkai.R.id.deviceName, books);
		this.results = books;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if ( convertView == null ) {
			...
			rowView = inflater.inflate(net.zorgblub.typhonkai.R.layout.progress_row, parent, false);
		} else {
			rowView = convertView;
		}

		TextView deviceView = (TextView) rowView.findViewById(net.zorgblub.typhonkai.R.id.deviceName);
		TextView percentageView = (TextView) rowView.findViewById(net.zorgblub.typhonkai.R.id.timeStamp );
        ...
        if ( pageNumber != -1 ) {
            text = String.format( getContext().getString(net.zorgblub.typhonkai.R.string.page_number_of),
