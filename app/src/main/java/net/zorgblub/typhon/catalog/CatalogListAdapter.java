...
public class CatalogListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ( convertView == null || convertView instanceof  ProgressBar  ) {
            ...
            rowView = inflater.inflate(net.zorgblub.typhon.R.layout.catalog_item, parent, false);
        } else {
            rowView = convertView;
        }
        ...
        ImageView icon = (ImageView) rowView.findViewById(net.zorgblub.typhon.R.id.itemIcon);
        ...
        icon.setImageDrawable( drawableOption.getOrElse(
                context.getResources().getDrawable(net.zorgblub.typhon.R.drawable.unknown_cover)
        ));
