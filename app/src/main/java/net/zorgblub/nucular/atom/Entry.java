 ...
 */
package net.zorgblub.nucular.atom;
...
import static net.zorgblub.nucular.atom.AtomConstants.REL_ALTERNATE;
import static net.zorgblub.nucular.atom.AtomConstants.REL_BUY;
import static net.zorgblub.nucular.atom.AtomConstants.REL_COVER;
import static net.zorgblub.nucular.atom.AtomConstants.REL_IMAGE;
import static net.zorgblub.nucular.atom.AtomConstants.REL_RELATED;
import static net.zorgblub.nucular.atom.AtomConstants.REL_STANZA_BUY;
import static net.zorgblub.nucular.atom.AtomConstants.REL_STANZA_COVER_IMAGE;
import static net.zorgblub.nucular.atom.AtomConstants.REL_STANZA_THUMBNAIL_IMAGE;
import static net.zorgblub.nucular.atom.AtomConstants.REL_THUMBNAIL;
import static net.zorgblub.nucular.atom.AtomConstants.REL_THUMBNAIL_ALT;
import static net.zorgblub.nucular.atom.AtomConstants.TYPE_ATOM;
import static net.zorgblub.nucular.atom.AtomConstants.TYPE_EPUB;
