...
public class ReadingFragment extends RoboSherlockFragment implements
    ...
    private boolean rikaiLookupEnabled = true;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            dictionaries.add(new DroidWordEdictDictionary("/sdcard/PageTurner/polaredict.sqlite", new Deinflector("/sdcard/PageTurner/deinflect.dat"), new DroidSqliteDatabase(), getResources()));
        } catch (IOException e) {
            LOG.error("Could not deinflector data", e);
        }
        dictionaries.add(new DroidKanjiDictionary("/sdcard/PageTurner/kanji.dat", getResources()));
        dictionaries.add(new DroidNamesDictionary("/sdcard/PageTurner/polarnames.sqlite", new DroidSqliteDatabase(), getResources()));
