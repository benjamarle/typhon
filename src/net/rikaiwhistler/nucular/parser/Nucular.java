 ...
 */
package net.rikaiwhistler.nucular.parser;

import net.rikaiwhistler.nucular.atom.Feed;
import net.rikaiwhistler.nucular.parser.opensearch.OpenSearchParser;
import net.rikaiwhistler.nucular.parser.opensearch.SearchDescription;
