...
public class DialogFactory {
	...
	public AlertDialog buildAboutDialog() {
		...
		builder.setTitle(net.rikaiwhistler.pageturner.R.string.about);
		builder.setIcon(net.rikaiwhistler.pageturner.R.drawable.page_turner);
		...
		String html = "<h2>" + context.getString(net.rikaiwhistler.pageturner.R.string.app_name) + " " +  version + "</h2>";
		html += context.getString(net.rikaiwhistler.pageturner.R.string.about_gpl);
