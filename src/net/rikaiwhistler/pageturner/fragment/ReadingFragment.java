...
import net.rikaiwhistler.pageturner.Configuration.ReadingDirection;
import net.rikaiwhistler.pageturner.Configuration.ScrollStyle;
import net.rikaiwhistler.pageturner.R;
import net.rikaiwhistler.pageturner.TextUtil;
import net.rikaiwhistler.pageturner.activity.LibraryActivity;
import net.rikaiwhistler.pageturner.activity.MediaButtonReceiver;
...
import net.rikaiwhistler.pageturner.animation.Animations;
import net.rikaiwhistler.pageturner.animation.Animator;
import net.rikaiwhistler.pageturner.animation.PageCurlAnimator;
import net.rikaiwhistler.pageturner.animation.PageTimer;
import net.rikaiwhistler.pageturner.animation.RollingBlindAnimator;
import net.rikaiwhistler.pageturner.bookmark.Bookmark;
import net.rikaiwhistler.pageturner.bookmark.BookmarkDatabaseHelper;
import net.rikaiwhistler.pageturner.dto.HighLight;
import net.rikaiwhistler.pageturner.dto.SearchResult;
import net.rikaiwhistler.pageturner.dto.TocEntry;
import net.rikaiwhistler.pageturner.epub.SearchTextTask;
import net.rikaiwhistler.pageturner.library.LibraryService;
import net.rikaiwhistler.pageturner.sync.AccessException;
import net.rikaiwhistler.pageturner.sync.BookProgress;
import net.rikaiwhistler.pageturner.sync.ProgressService;
import net.rikaiwhistler.pageturner.tts.TTSPlaybackItem;
import net.rikaiwhistler.pageturner.tts.TTSPlaybackQueue;
import net.rikaiwhistler.pageturner.view.AnimatedImageView;
import net.rikaiwhistler.pageturner.view.HighlightManager;
import net.rikaiwhistler.pageturner.view.NavGestureDetector;
import net.rikaiwhistler.pageturner.view.NavigationCallback;
import net.rikaiwhistler.pageturner.view.ProgressListAdapter;
...
import net.rikaiwhistler.ui.ActionModeBuilder;
...
import org.rikai.DroidSqliteDatabase;
import org.rikai.DroidWordEdictDictionary;
...
import org.rikai.glosslist.AdvancedArrayAdapter;
import org.rikai.glosslist.ExpandableListView;
