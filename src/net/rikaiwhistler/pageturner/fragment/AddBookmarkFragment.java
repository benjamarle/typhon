...
public class AddBookmarkFragment extends RoboSherlockDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(net.rikaiwhistler.pageturner.R.layout.fragment_add_bookmark, null);

        this.inputField = (EditText) view.findViewById(net.rikaiwhistler.pageturner.R.id.bookmark_name);
        ...
        return new AlertDialog.Builder(
                getActivity())
                .setTitle(net.rikaiwhistler.pageturner.R.string.add_bookmark)
                .setView( view )
                .setPositiveButton(net.rikaiwhistler.pageturner.R.string.add, (dialog, which) -> handleAction() )
