...
import net.rikaiwhistler.nucular.atom.AtomConstants;
...
import net.rikaiwhistler.pageturner.fragment.BookDetailsFragment;
import net.rikaiwhistler.pageturner.fragment.CatalogFragment;
import net.rikaiwhistler.pageturner.catalog.Catalog;
import net.rikaiwhistler.pageturner.catalog.CatalogParent;
...
public class CatalogActivity extends PageTurnerActivity implements CatalogParent {
    ...
    @Nullable
    @InjectFragment(net.rikaiwhistler.pageturner.R.id.fragment_book_details)
    ...
    protected int getMainLayoutResource() {
        return net.rikaiwhistler.pageturner.R.layout.activity_catalog;
    }
    ...
    public void loadCustomSitesFeed() {
        ...
        if ( sites.isEmpty() ) {
            Toast.makeText(this, net.rikaiwhistler.pageturner.R.string.no_custom_sites, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        customSites.setTitle(getString(net.rikaiwhistler.pageturner.R.string.custom_site));
        ...
        fragmentTransaction.replace(net.rikaiwhistler.pageturner.R.id.fragment_catalog, newCatalogFragment, Catalog.CUSTOM_SITES_ID );
    ...
    public void loadFeed(Entry entry, String href, String baseURL, boolean asDetailsFeed) {
        ...
        fragmentTransaction.replace(net.rikaiwhistler.pageturner.R.id.fragment_catalog, newCatalogFragment, baseURL);
