...
import net.rikaiwhistler.pageturner.fragment.LibraryFragment;

import roboguice.inject.InjectFragment;

public class LibraryActivity extends PageTurnerActivity {

    @InjectFragment(net.rikaiwhistler.pageturner.R.id.fragment_library)
    private LibraryFragment libraryFragment;

    @Override
    protected int getMainLayoutResource() {
        return net.rikaiwhistler.pageturner.R.layout.activity_library;
    }
