...
public class FileAdapter extends BaseAdapter {
    ...
    public void setFolder( File folder ) {
        ...
        items.add( 0, new FileItem( "[" + context.getString(net.rikaiwhistler.pageturner.R.string.import_this) + "]", folder, true));
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if ( convertView == null ) {
            rowView = inflater.inflate(net.rikaiwhistler.pageturner.R.layout.folder_line, parent, false);
        } else {
            rowView = convertView;
        }

        ImageView img = (ImageView) rowView.findViewById(net.rikaiwhistler.pageturner.R.id.folderIcon);
        CheckBox selectBox = (CheckBox) rowView.findViewById(net.rikaiwhistler.pageturner.R.id.selectBox);

        if ( fileItem.getFile().isDirectory() ) {
            img.setImageDrawable( context.getResources().getDrawable(net.rikaiwhistler.pageturner.R.drawable.folder));
            selectBox.setVisibility(View.VISIBLE);
        } else {
            img.setImageDrawable( context.getResources().getDrawable(net.rikaiwhistler.pageturner.R.drawable.file));
        ...
        TextView label = (TextView) rowView.findViewById(net.rikaiwhistler.pageturner.R.id.folderName);
