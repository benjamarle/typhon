...
public class CatalogListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ( convertView == null || convertView instanceof  ProgressBar  ) {
            ...
            rowView = inflater.inflate(net.rikaiwhistler.pageturner.R.layout.catalog_item, parent, false);
        } else {
            rowView = convertView;
        }
        ...
        ImageView icon = (ImageView) rowView.findViewById(net.rikaiwhistler.pageturner.R.id.itemIcon);
        ...
        icon.setImageDrawable( drawableOption.getOrElse(
                context.getResources().getDrawable(net.rikaiwhistler.pageturner.R.drawable.unknown_cover)
        ));
