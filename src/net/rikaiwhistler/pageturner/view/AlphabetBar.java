...
public class AlphabetBar extends LinearLayout
{
    ...
    public AlphabetBar(Context context, AttributeSet attrs)
    {
        ...
        if ( profile == Configuration.ColourProfile.DAY ) {
        	setBackgroundResource(net.rikaiwhistler.pageturner.R.drawable.alphabet_bar_bg);
        } else {
        	setBackgroundResource(net.rikaiwhistler.pageturner.R.drawable.alphabet_bar_bg_dark);
        }
